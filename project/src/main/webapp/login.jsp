 ...
 */
    ...
    <!--<script type="text/javascript" charset="utf8" async="" src="./登录_files/vds.js.下载"></script>-->
    <!--<script type="text/javascript" charset="utf-8" async="" src="./登录_files/14-9d4191.js.下载"></script>-->
    <style type="text/css">
        .mz-pagination {
            font-size: 14px;
            color: #808080;
    ...
    <!--<script type="text/javascript" charset="utf-8" async="" src="./登录_files/11-54fadc.js.下载"></script>-->
    <style type="text/css">
        .cinema-list-view {
            padding: 23px 0 80px;
        }
    ...
    <!--<script type="text/javascript" charset="utf-8" async="" src="./登录_files/4-94c1ee.js.下载"></script>-->
    <style type="text/css">
        .mini-seating-chart {
            padding: 20px 12px;
            border: 10px solid #e5e5e5;
    ...
    <div data-reactroot="">
        <div class="application">F
            ...
            <div class="application-main">
                <div class="login-view" style="background:url(&quot;https://pic.maizuo.com/manager/6f214638a922e26b818004d8eebc03c3.jpg&quot;) center center no-repeat;">
                    <div class="inner">
                        <div class="login-form-view">
                            ...
                            <div class="service">
                                <ul class="third-login">
                                    <li>
                                        <a><img src="http://119.23.42.247:83/img/ce402ffd0ccd2499f976e53db87ecf90.png" width="33"></a>
                                    </li>
                                    <!-- react-text: 2298 -->
                                    <!-- /react-text -->
                                </ul>
            ...
            <div class="footer">
                <div class="content inner">
                    <h2><img src="http://119.23.42.247:83/img/97d132d70ddef38021064aae67963766.png" alt="卖座"><!-- react-text: 67 -->电影订座&nbsp;&nbsp;就上卖座<!-- /react-text --></h2>
